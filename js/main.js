...
const quizData = [
  {
    ...
    options: ["Одна, я слежу за собой", "Две — утром и после обеда", "Сколько налито — столько и нормально"],
    correct: 2,
  ...
  {
    q: "Сколько часов в сутки Люба сидит в Инстаграме?",
    options: ["Я не сижу в Инстаграме 20 часов в сутки", "Ну... иногда часа три-четыре", "Постоянно, это моя работа"],
    correct: 0,
